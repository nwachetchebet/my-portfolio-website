   ...
   const modalHeader = document.querySelector('.modal_header')
    ...
    if (response.ok) {
        ...
        if (Object.hasOwn(data, 'errors')) {
            modalView.classList.add('active-modal')
            modalParagraph.innerHTML = data["errors"].map(error => error["message"]).join(", ")
            //tatus.innerHTML = data["errors"].map(error => error["message"]).join(", ")
            modalHeader.innerHTML = " "
        } else {
           // status.innerHTML = "Oops! There was a problem submitting your form"
           modalView.classList.add('active-modal')
            modalParagraph.innerHTML = "There has been a problem submtting your form, Please try again"
            modalHeader.innerHTML = " OOPS"
        }
        })
    }
    }).catch(error => {
    modalParagraph.innerHTML = "Oops! There was a problem submitting your form"
    });
}
